...
--[[
    ...
    the RematchRedux 5.0 thread. Thanks!
]]
...
L["Leveling"] = nil
L["This pet is in RematchRedux's leveling queue."] = nil
L["Breed"] = nil
...
L["Save As"] = nil
L["RematchRedux"] = nil
L["Remove RematchRedux From Journal"] = nil
L["Uncheck this to restore the default pet journal.\n\nYou can still use RematchRedux in its standlone window, accessed via key binding, /rematch command or from the Minimap button if enabled in options."] = nil
...
L["To this:"] = nil
L["Sending Team"] = nil
L["Not yet implemented\n\nSending teams directly to other RematchRedux users will be added later in the beta."] = nil
L["Targets"] = nil
L["Preferences"] = nil
L["Wins"] = nil
...
-- layout\frame.lua
L["RematchRedux can't be summoned during combat. Try again later"] = nil

-- layout\journal.lua
L["Use RematchRedux In Journal"] = nil
L["Check this to restore RematchRedux to the journal.\n\nYou can always use RematchRedux in its standalone window, accessed via key binding, /rematch command or from the Minimap button if enabled in options."] = nil

-- main\constants.lua
L["Toggle RematchRedux"] = nil
L["RematchRedux Team Notes"] = nil
...
L["Reset everything?"] = nil
L["This will wipe all settings, teams, queue, etc (absolutely everything), and then reload the UI to start RematchRedux from scratch."] = nil
...
L["Export Queue"] = nil
L["Export all pets in the leveling queue for later importing.\n\n%sNote\124r: RematchRedux will make a best guess what to import, but there's no guarantee the exact same pets will import, especially after they've leveled. This works best without many duplicates."] = nil
L["Import Queue"] = nil
...
L["Up to %d groups can be chosen to display as tabs along the right side of the RematchRedux window.\n\n%s%d of %d\124r possible tabs are shown."] = nil
...
L["When a team is loaded from an interaction (target or mouseover) and the RematchRedux window is not on screen, summon the standalone RematchRedux window."] = nil
L["Only When Any Pets Injured"] = nil
L["If a team is loaded but no pets are injured, don't summon the RematchRedux window."] = nil
...
L["Show the standalone RematchRedux window after leaving a pet battle."] = nil
...
L["When a toolbar button is used with a right click, dismiss the RematchRedux window after performing its action."] = nil
...
L["When you learn new pets, temporarily sort them to the top of the pet list until you next close RematchRedux or choose Reset All from the filter menu."] = nil
...
L["Don't hide notes when changing tabs or closing RematchRedux."] = nil
...
L["Turn off RematchRedux integration with the default pet journal.\n\nYou can still use RematchRedux in its standalone window, accessed via key binding, /rematch command or from the Minimap button if enabled in options."] = nil
...
L["Place a button on the minimap to toggle RematchRedux and load favorite teams."] = nil
L["No Summon On Double Click"] = nil
L["Do nothing when pets within RematchRedux are double-clicked. The normal behavior of double click throughout RematchRedux is to summon or dismiss the pet."] = nil
...
L["No breed information will be shown if this is selected. RematchRedux does not maintain its own breed data."] = nil
...
L["Show Window"] = nil
L["When targeting an NPC with a saved team not already loaded, show the standalone RematchRedux window."] = nil
L["Auto Load"] = nil
...
L["When soft interacting with an NPC with a saved team not already loaded, show the standalone RematchRedux window."] = nil
...
L["When the mouse moves over an NPC with a saved team not already loaded, show the standalone RematchRedux window."] = nil
...
L["Medium"] = nil
L["Large"] = nil
L["Adjust the relative size of the standalone RematchRedux window by changing its scale."] = nil
...
-- process\send.lua
L["Send"] = nil
L["Enter the name of an online RematchRedux user:"] = nil
L["Send To:"] = nil
L["Sending, please wait..."] = nil
L["Incoming RematchRedux Team"] = nil
L["Someone"] = nil
L["%s%s has sent you a team!"] = nil
L["No response. This player is not online or doesn't have RematchRedux enabled."] = nil
...
L["Backup Teams"] = nil
L["You have %s%d\124r RematchRedux teams.\n\nWould you like to back them up now?"] = nil
L["Choosing Yes will export all teams to copy and paste in an email to yourself or someplace safe.\n\nYou can also do this at any time from the Teams button at the top of the Teams panel of RematchRedux."] = nil

-- process\toast.lua
L["Now leveling:"] = nil
L["RematchRedux's leveling queue is empty"] = nil
...
L["This will reset most options, set them to values pasted here, then reload the UI. %sUse this at your own risk!\124r Tinkering with these values can cause RematchRedux to become unstable and require a full reset."] = nil
...
L["Try to hide any badges added to lists from an external source like a third-party addon. (RematchRedux has no control over what outside addons do, so some addon's badges may not hide with this option.)"] = nil
