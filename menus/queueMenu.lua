...
rematchRedux.events:Register(rematchRedux.queueMenu,"PLAYER_LOGIN",function(self)
    ...
    local menu = {
        ...
        {text=L["Descending Level"], radio=qm.IsActiveSort, sort=C.QUEUE_SORT_DESC, isChecked=qm.IsCurrentSort, func=qm.SetCurrentSort, icon="Interface\\AddOns\\RematchRedux\\textures\\badges-borders", iconCoords={0.25,0.375,0.375,0.5}},
        {spacer=true},
        {text=L["In Teams First"], check=qm.IsActiveSort, var="QueueSortInTeamsFirst", sort=C.QUEUE_SORT_TEAMS, isChecked=qm.IsFirstChecked, func=qm.SetFirstSort, icon="Interface\\AddOns\\RematchRedux\\textures\\badges-borders", iconCoords={0.5,0.625,0.125,0.25}},
        {text=L["Favorites First"], check=qm.IsActiveSort, var="QueueSortFavoritesFirst", sort=C.QUEUE_SORT_FAVORITES, isChecked=qm.IsFirstChecked, func=qm.SetFirstSort, icon="Interface\\AddOns\\RematchRedux\\textures\\badges-borders", iconCoords={0.625,0.75,0.375,0.5}},
        {text=L["Rares First"], check=qm.IsActiveSort, var="QueueSortRaresFirst", sort=C.QUEUE_SORT_RARITY, isChecked=qm.IsFirstChecked, func=qm.SetFirstSort, icon="Interface\\AddOns\\RematchRedux\\textures\\badges-borders", iconCoords={0.5,0.625,0.375,0.5}},
        {spacer=true},
