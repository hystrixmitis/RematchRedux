...
--[[
    ...
    The list of species is generated by roster while scanning the pet journal:
        for speciesID in rematchRedux.roster:AllSpecies() do etc end
]]
...
local speciesMovesets = rematchRedux.odTable:Create(function(self)
    for speciesID in rematchRedux.roster:AllSpecies() do
        self[speciesID] = rematchRedux.petInfo:Fetch(speciesID).moveset
    end
end,true)
...
local sourceIDs = rematchRedux.odTable:Create(function(self)
    ...
    rematchRedux.roster:RestoreJournal() -- put everything back how it was
...
local speciesCantBattle = rematchRedux.odTable:Create(function(self)
    for speciesID in rematchRedux.roster:AllSpecies() do
...
function rematchRedux.speciesInfo:CanBattle(speciesID)
    if speciesID then
